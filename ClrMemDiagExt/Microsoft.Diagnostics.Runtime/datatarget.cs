...
#pragma warning disable 0618
    ...
    public class PdbInfo
    {
        ...
        public override string ToString()
        {
            return String.Format("{0} {1} {2}", Guid, Revision, FileName);
        }
    }
    ...
    internal class DataTargetImpl : DataTarget
    {
        ...
        private static Regex s_invalidChars = new Regex(String.Format("[{0}]", Regex.Escape(new string(System.IO.Path.GetInvalidPathChars()))));
    ...
    internal unsafe class LiveDataReader : IDataReader
    {
        ...
        public IList<ModuleInfo> EnumerateModules()
        {
            ...
            for (int i = 0; i < modules.Length; i++)
            {
                ...
                GetFileProperties(baseAddr, out filesize, out timestamp);
